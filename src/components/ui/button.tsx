...
const buttonVariants = cva(
  "relative inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-medium transition-all duration-300 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground shadow-[0_0_0_1px_hsl(var(--primary)/0.4)] hover:shadow-[0_0_0_1px_hsl(var(--primary)/0.6),0_8px_24px_-8px_hsl(var(--primary)/0.6)] hover:-translate-y-0.5",
        outline:
          "border border-border bg-transparent hover:bg-surface-elevated hover:-translate-y-0.5",
        ghost: "hover:bg-surface-elevated",
        glass: "glass hover:bg-surface-elevated/80 hover:-translate-y-0.5",
